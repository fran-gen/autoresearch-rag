...
logger = logging.getLogger("download_half_dataset")
...
def main() -> int:
    ...
    loader.download_release_files(include_all_documents=True, document_fraction=0.5)
    logger.info("Downloaded half dataset under %s.", settings.benchmark_root.resolve())
    return 0
